...
(function (root, factory) {
  ...
  exports.render = function () {
    var nodes = document.querySelectorAll('img[data-echo], a[data-echo]');
  ...
  var display_image = function(elem){
    var nodeName = elem.nodeName.toLowerCase(),
        url = elem.getAttribute('data-echo');
    ...
    if(nodeName === "img"){
      ...
      console.log("unable to load image in ", nodeName, elem);
    }
  };
