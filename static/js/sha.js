(function(){
  ...
  window.array_to_base64 = function(ary) {
    var binary = '';
  ...
  */
  ...
  window.HMAC_SHA256_init = function(key) {
    var i;

    if (typeof(key) == "string")
      HMAC_SHA256_key = string_to_array(key);
    else
      HMAC_SHA256_key = [].concat(key);
    ...
    for(i = HMAC_SHA256_key.length; i < 64; i++)
      HMAC_SHA256_key[i] = 0;
    for(i = 0; i < 64; i++)
  ...
  */
  ...
  window.HMAC_SHA256_write = function(msg) {
    SHA256_write(msg);
  };
  ...
  */
  ...
  window.HMAC_SHA256_finalize = function() {
    var i;
